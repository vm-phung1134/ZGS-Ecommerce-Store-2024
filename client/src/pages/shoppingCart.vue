        ...
        <div class="flex gap-10 mx-20">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-base-200">
                                ...
                                <td>
                                    <img class="w-20"
                                        src="https://asset.msi.com/resize/image/global/product/product_17035046674023a211767f3af074d5b9f843f5f9e1.png62405b38c58fe0f07fcef2367d8a9ba1/400.png"
                                        alt="">
                                </td>
                                <td>1</td>
                                <td>$20</td>
            ...
            <div class="w-4/12">
                <div class="shadow-xl h-full p-5 flex flex-col gap-5">
                    ...
                    <p class="italic">Place your order now to get a lot of things from our events in the black friday 20/03/2024.</p>
                    ...
                    <div class="flex justify-between text-lg items-center">
                        ...
                        <p class="font-bold text-red-600 text-2xl">$3000.00</p>
                    </div>
